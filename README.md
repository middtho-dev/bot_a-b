...
- Учитываются сообщения из рабочих чатов (`WORK_CHAT_IDS`).
...
> Если в отчёте везде 0, обычно причина — сотрудник не добавлен, chat_id не настроен или сообщения шли не в рабочий чат.
